...
"""
models.py - Complete Timetable System Models
All constraints and validations included + ELECTIVE SUPPORT
"""
...
class Section(models.Model):
    ...
    # ✅ NEW: Elective support
    is_elective = models.BooleanField(default=False, help_text="Is this an elective section?")
    elective_group = models.CharField(max_length=10, blank=True, null=True, help_text="G1 or G2 for electives")
